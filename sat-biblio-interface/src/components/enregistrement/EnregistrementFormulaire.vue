<template>
  <b-form @submit.prevent="onSubmit">
      ...
      <b-form-group label="Année">
        <b-form-input v-model="record.annee" :disabled="disabled"/>
      </b-form-group>
      <b-form-group label="Nombre d'exemplaires supplémentaires">
        <b-form-input v-model="record.nb_exemplaire_supp" :disabled="disabled"/>
      </b-form-group>
      <b-form-group label="Provenance">
        <b-form-input v-model="record.provenance" :disabled="disabled"/>
      </b-form-group>
